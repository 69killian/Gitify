...
const Content = ({ className }: ContentProps) => {
  ...
  return (
    <div className={`max-w-md w-full p-8 bg-gradient-to-b from-[#0E0913] to-[#160E1E] transition-colors duration-300 rounded-[8px] p-1 shadow-md shadow-[#101010] border-t-2 border-gray-300/10 border border-[#292929] text-[16px] ${className || ''}`}>
